import {
  ...
  where,
  writeBatch
} from "./chunk-W6Q32PBL.js";
import {
  base44,
  firebaseClient
} from "./chunk-V5K472MA.js";
import {
  require_jsx_runtime
} from "./chunk-SY54FM37.js";
import {
  Navigate
} from "./chunk-UVX4SZTE.js";
...
// ../shared/src/api/entities/AppUser.js
...
var AuthProvider = ({ children }) => {
  ...
  (0, import_react.useEffect)(() => {
    if (!auth) {
      console.warn("Firebase auth not available. Running in development mode.");
      const port = window.location.port;
      const role = port === "3001" ? "player" : "admin";
      const email = port === "3001" ? "player@example.com" : "admin@example.com";
      const name = port === "3001" ? "Development Player" : "Development Admin";
    ...
    const timeout = setTimeout(() => {
      console.warn("Auth initialization timeout. Setting mock data for development.");
      const port = window.location.port;
      const role = port === "3001" ? "player" : "admin";
      const email = port === "3001" ? "player@example.com" : "admin@example.com";
      const name = port === "3001" ? "Development Player" : "Development Admin";
      setUser({ uid: "dev-user-timeout", email });
      setUserData({
        id: "dev-user-timeout",
        role,
        status: "approved",
  ...
  const login = async (email, password) => {
    if (!auth) {
      console.warn("Firebase auth not available. Cannot login.");
  ...
  const logout = async () => {
    if (!auth) {
      console.warn("Firebase auth not available. Cannot logout.");
      return;
    }
    await signOut(auth);
  };
...
// ../shared/src/components/ui/card.jsx
...
// ../shared/src/components/LoadingSpinner.tsx
...
// ../shared/src/components/AccessDenied.tsx
...
// ../shared/src/components/ProtectedRoute.tsx
...
// ../shared/src/components/ErrorMessage.tsx
...
// ../shared/src/components/ChatSystem.tsx
var import_react5 = __toESM(require_react());

// ../shared/src/hooks/useChat.ts
...
// ../shared/src/hooks/usePresence.ts
...
// ../shared/src/hooks/useOfflineQueue.ts
...
// ../shared/src/api/entities/Player.js
var list = (options = {}) => {
...
var User2 = {
  me: async () => {
    const { auth: auth2 } = await import("./firebase-ML5QEEFZ.js");
...
// ../shared/src/utils/tokenValidation.js
...
// ../shared/src/utils/secureLogger.js
var LOG_LEVELS = {
  ERROR: "ERROR",
  WARN: "WARN",
  INFO: "INFO",
...
// ../shared/src/api/integrations/documentationService.js
...
// ../shared/src/api/integrations/aiService.js
...
// ../shared/src/api/integrations/emailService.js
...
// ../shared/src/api/integrations/fileUpload.js
...
// ../shared/src/api/integrations/imageGeneration.js
...
// ../shared/src/api/integrations.js
var Core = {
  InvokeLLM: invokeLLM,
  SendEmail: sendEmail,
...
// ../shared/src/services/authRedirect.ts
...
// ../shared/src/services/chatService.ts
...
// ../shared/src/services/notificationService.ts
